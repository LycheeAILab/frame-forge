...
Use [the bundled preview](../../../assets/previews/abstract.jpg) only for style selection. Do not reuse its subject matter, title, colors, or composition unless the user explicitly requests those details. Follow the current written style constraints for generation.
