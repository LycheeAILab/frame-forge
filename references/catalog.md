...
路径相对本文件；渲染图片前解析为绝对路径。

以下图片为客户选择风格的固定示例，随 skill 一起分发。使用安装目录下的 assets/previews 文件，不能引用开发者电脑路径；编号与图片一一对应。

| 编号 | 中文名 | 可匹配名称 | 特点 | 规则 | 预览 |
|---|---|---|---|---|---|
| 1 | 极简纸刊 | minimal / minimal zine | 大留白、纸纹、小主体、单一亮色 | styles/minimal/rules.md | ../assets/previews/minimal.jpg |
| 2 | 月历明信片 | monthly / monthly postcard | 完整照片、水彩、月份与书影音 | styles/monthly/rules.md | ../assets/previews/monthly.jpg |
| 3 | 照片抽象编辑 | abstract / abstract editorial | 原照片搭配关系派生的抽象面板与标题 | styles/abstract/rules.md | ../assets/previews/abstract.jpg |
| 4 | 实景纸感拼贴 | gathered / scene collage | 真实摄影、插画、结构性色彩、撕纸边界 | styles/gathered/rules.md | ../assets/previews/gathered.jpg |
